...
1. Clone o repositório
  * `git clone https://github.com/tryber/sd-015-a-project-frontend-online-store.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-015-a-project-frontend-online-store`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-015-a-project-frontend-online-store/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-015-a-project-frontend-online-store/pulls) e confira que o seu _Pull Request_ está criado
...
- [Tela principal - Antes da busca](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_02.png)
...
- [Tela do carrinho de compras](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_03.png)
- [Tela principal - Com botão do carrinho de compras](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/bonus_shopping_cart_button.png)
...
- [Tela principal - Com a lista de categorias](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_04.png)
...
- [Tela principal - Após a busca](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_05.1.png)
- [Tela principal - Nenhum produto encontrado](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_05.2.png)
...
- [Tela - Detalhamento do produto](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_07.png)
...
- [Tela principal - Adicionar ao carrinho na exibição detalhada](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_13.png)
...
- [Tela - Carrinho de compras com quantidades](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_10.png)
...
- [Tela - Detalhamento do produto com avaliações](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_11.1.png)
- [Tela - Detalhamento do produto com avaliações pregressas](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_11.2.png)
...
- [Tela - Finalização de compra](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_12.png)
...
- [Tela - Listagem de produtos com carrinho e quantidade](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_13.png)
...
- [Tela principal - Exibição detalhada de produto com frete gratis](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_15.1.png)
- [Tela - Detalhamento de produto com frete gratis](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_15.2.png)
...
- [Tela principal - Ordenação por preço](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/bonus_ordering.png)
...
- [Tela - Listagem com carrinho populado.png](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/bonus_slider.1.png)
- [Tela - Listagem com carrinho vazio.png](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/bonus_slider.1.png)
...
- [Tela - Listagem com destaque.png](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/bonus_marked_product.png)
...
- [Tela - Detalhamento do produto com quantidade.png](https://github.com/tryber/sd-015-a-project-frontend-online-store/tree/master/wireframes/card_09.png)
